...
import { Form, Button, Message, Input, TransitionablePortal} from 'semantic-ui-react';
...
class RequestNew extends Component {
    ...
    onSubmit = async event => {
        ...
        // we can use the address to get access to campaign instance
        ...
        try {
            ...
            // navigate user back to requests page with Router component
